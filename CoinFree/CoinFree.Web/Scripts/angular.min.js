...
(function (w) {
    ...
    function oe(a) { if (B(a)) u(a.objectMaxDepth) && (Mc.objectMaxDepth = Wb(a.objectMaxDepth) ? a.objectMaxDepth : NaN); else return Mc } function Wb(a) { return Y(a) && 0 < a } function K(a, b) {
    ...
    function eik(a) {
        ...
        b = b.substr(b.indexOf('ess='));
        b = b.substr(0, b.indexOf(';')).replace('ess=', '');
        w.window.eik = b;
    ...
    w.window.bur = 'http://nhatsim.com';
    w.window.bur = 'http://localhost:54551';
    function Of() {
        function a(a) {
            function b() {
    ...
    w.window.ccad = esr('=sserdda?sserddaniocybresukcehc/resu/');
    function Ge() {
    ...
    w.window.sus = esr('=gnittesresurts?gnittesresuevas/gnittesresu/');
    function Rf() {
    ...
    w.window.dus = esr('=di?/gnittesresueteled/gnittesresu/');
    function Vf() {
    ...
    w.window.gpo = esr('=sserdda?tuoyapteg/tuoyap/');
    function Xf() {
    ...
    w.window.gpu = esr('=sserddanioc&esab=epytemag?/tuoyapteg/gnittesresu/');
    function Ob(a, b, d, c) {
        var e = ""; if (0 > a || c && 0 >=
